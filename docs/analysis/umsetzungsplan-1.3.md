...
| 2 Nutzerwunsch 2026-09-14: eigene USB-Gerätenamen (einmal vergeben, überall: Regeln, „Apps warten auf Gerät“, Toasts; wie Monitornamen) und Regeln mit mehreren Geräten („alle müssen da sein“; Ende, sobald eines nach der Wartezeit fehlt) – beides Nutzerentscheidung mit Empfehlung | U-01, U-02 | offen | |
| 2 Beobachtung Update-Log Gaming-PC: nach RDP-Trennung Theme 2× und Tray-Icon 7× neu gesetzt | R-01 | offen | |
| 2 Nutzerwunsch: vor 1.4.0 alle Seiten, Menüs, Dialoge visuell prüfen (de/en, hell/dunkel, schmal/breit) | V-01 | offen | |
